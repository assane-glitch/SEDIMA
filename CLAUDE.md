...
- UI en francais, sans accents dans les chaines de code sauf libelles de navigation ; charte : barre de navigation anthracite `ink` a texte blanc en haut de l'ecran (hauteur 52 px, 60 px sur md ; les barres collantes des pages utilisent `top-[52px] md:top-[60px]`), fond gris, cartes blanches a bordure 1 px, pas d'ombre, bouton primaire anthracite, rouge `brand` reserve aux marqueurs, jaune `accent` pour le surlignage, etoile de favori pleine en anthracite, pictogrammes de categorie en rouge (`CategoryIcon`).
