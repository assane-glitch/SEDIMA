...
- Graphiques (Apercu d'un projet) : SVG maison sans bibliotheque, deux series categorielles validees `chart-1` (bleu, prevu) et `chart-2` (vert, realise), rampe verte `chart-seq-*` pour les repartitions, un seul axe par graphique, infobulle au survol, legende a cases.
