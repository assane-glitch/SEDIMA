...
export function Sidebar({ groups, profile, signOut }: { groups: NavGroup[]; profile: Profile; signOut: () => Promise<void> }) {
  ...
  return (
    <aside className="sticky top-[72px] z-[25] mt-3 hidden h-[calc(100vh-72px-0.75rem)] w-14 shrink-0 flex-col rounded-xl border border-line-hair bg-surface p-2 md:flex">
